...
public class TestRegenerate
{
  ...
  /**
   * Test /api/edit/transcripts/layers/regenerate endpoint will regenerate layers
  ...
  @Test public void regenerateByParameter()
    ...
    try {
      ...
      // regenerate a layer
      HttpRequestPost request = l.post("api/edit/transcripts/layers/regenerate")
  ...
  @Test public void regenerateByFile()
    ...
    assertTrue("getTranscriptIds: At leas two IDs are returned",
               ids.length >= 2);
    File listFile = new File(getDir().getParentFile(), "transcripts.txt");
    ...
    try {
      ...
      HttpRequestPostMultipart request = l.postMultipart(
        "api/edit/transcripts/layers/regenerate")
        .setParameter("layerId", "orthography")
  ...
  /**
   * Test /api/edit/transcripts/layers/regenerate endpoint parameter validation.
   */
  @Test public void validation()
    ...
    try {
      ...
      request = l.post("api/edit/transcripts/layers/regenerate")
  ...
  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("nzilbb.labbcat.server.api.edit.transcripts.layers.TestRegenerate");
  }
}
