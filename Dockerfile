...
RUN mkdir /opt/praat
WORKDIR /opt/praat
RUN wget https://github.com/praat/praat/releases/download/v6.6.30/praat6630_linux-x64v3-barren.tar.gz
RUN tar xvf praat6630_linux-x64v3-barren.tar.gz
RUN rm praat6630_linux-x64v3-barren.tar.gz
