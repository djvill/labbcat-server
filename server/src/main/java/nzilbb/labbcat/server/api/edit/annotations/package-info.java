...
//
/**
 * <p> <tt>/api/edit/annotations/&hellip;</tt>
 * : API endpoints for users with editing multiple annotations.
 *
 * <p> (These class implementations are decoupled from any HTTP request/response object model.
 * HTTP transaction details are currently implemented by JSP files in <tt>src/main/jsp/edit/annotations/</tt>)
 */
